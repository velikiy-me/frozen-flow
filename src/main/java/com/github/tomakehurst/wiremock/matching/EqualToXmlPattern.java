 ...
 * MODIFICATIONS:
 *
 * This file has been modified by Vladimir Velikiy to fix a race condition issue with the class level Document
 * instance (see ConcurrentStubMatchingTest.kt).
 */
...
public class EqualToXmlPattern extends StringValuePattern {
    ...
    public EqualToXmlPattern(
        ...
        super(expectedValue);
        this.documentBuilderFactory = getDocumentBuilderFactory(namespaceAwareness);
    ...
    public MatchResult match(final String value) {
        return new MatchResult() {
            ...
            public boolean isExactMatch() {
                ...
                try {
                    Document expectedXmlDoc = Xml.read(expectedValue, documentBuilderFactory);
