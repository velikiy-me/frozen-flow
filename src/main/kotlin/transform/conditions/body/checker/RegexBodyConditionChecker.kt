...
object RegexBodyConditionChecker : RequestBodyConditionChecker {
    ...
    override fun check(body: RequestBodyAccessor, condition: Condition): Boolean {
        ...
        val regex = condition.value.toRegex()
        return value.any { v ->
            check(v is String) {
                "Expected string value or list of strings for referenced value(s): '${condition.ref}'!"
            }
            regex.matches(v)
        }
    }
