...
object RegexJsonBodyPatternProcessor : RequestBodyPatternProcessor {
    ...
    override fun process(
        ...
        require(requestBodyPattern.value is String) {
        ...
        body.map(requestBodyPattern.ref) { currentValue, ref, _ ->
            ...
            /*require(requestBodyPattern.value.toRegex().matches(currentValue)) {
                "Attribute value: '$currentValue' does not match specified regex: '${requestBodyPattern.value}' " +
                    "for attribute: '$ref'!"
            }*/
            ...
            request.bodyPatterns.add(
                MatchesJsonPathPattern(
                    ref,
                    RegexPattern(requestBodyPattern.value)
                )
            )
